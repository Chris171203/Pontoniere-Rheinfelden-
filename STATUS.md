...
- Beide Rhein-Kurzkarten zeigen den BAFU-Wasserstand primär in `m ü.M.`. Direkt darunter steht zusätzlich der relative Pegel in `cm`: Basel bezogen auf 240.00 m ü.M., Rheinfelden bezogen auf den historischen BAFU-Pegelnullpunkt 260.00 m ü.M.
