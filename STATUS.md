...
Stand: Testversion `0.10.11` · aktualisiert 2026-09-04.
...
- In der App-Ansicht öffnet `Personen` die Verwaltung zum Hinzufügen und Entfernen. Wenn die externe Seite das Hinzufügen-Control auf einem ungewöhnlichen Seitenstand nicht anbietet, bleibt die Verwaltung trotzdem geöffnet und vorhandene Zusatzpersonen können weiterhin entfernt werden.
...
- `Alle Personen anzeigen` und entsprechende Bulk-Aktionen dürfen im App-Modus weder sichtbar noch auslösbar sein. Der Button `Personen` muss auch dann weiterhin die Verwaltung öffnen, wenn das externe Add-Control fehlt.
