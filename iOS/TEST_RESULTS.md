...
Aktuelle Version: [Abnahme 0.15.2](../docs/checks-0.15.2.md). Frühere Nachweise bleiben unter [Abnahme 0.15.1](../docs/checks-0.15.1.md) und [Abnahme 0.15.0](../docs/checks-0.15.0.md) dokumentiert. Die nachfolgenden Ergebnisse sind historische Nachweise für 0.12.6.
