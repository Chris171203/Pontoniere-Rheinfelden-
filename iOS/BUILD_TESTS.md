...
Stand 2026-09-14. Aktuelle iOS-Testversion `0.15.2`, Bundle-ID `ch.pfvr.app.test`, Mindestversion iOS/iPadOS 17. Das Xcode-Projekt wird ohne Quellcodeänderungen aus `project.yml` erzeugt. SwiftPM verwendet Tools 5.9 und Swift-Sprachmodus 5.
