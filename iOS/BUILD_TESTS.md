...
Stand 2026-09-14. Aktuelle iOS-Testversion `0.15.1`, Bundle-ID `ch.pfvr.app.test`, Mindestversion iOS/iPadOS 17. Das Xcode-Projekt wird ohne Quellcodeänderungen aus `project.yml` erzeugt. SwiftPM verwendet Tools 5.9 und Swift-Sprachmodus 5.
...
Für einen signierten TestFlight-Kandidaten bleiben die bestätigte App-Identität samt Apple-Team, sicher bereitgestellte Signiermittel sowie eine ausdrücklich freigegebene Verteilung offen. Das auf Nutzerwunsch verwendete Vereinslogo ist im Gerätearchiv geprüft; ein höher aufgelöstes Original ist eine optionale Qualitätsverbesserung. Die vorhandene Test-Bundle-ID bleibt bis zu dieser Entscheidung bestehen. Bei einem ID-Wechsel müssen auch der BGTask-Identifier in Info.plist und im Scheduler gemeinsam angepasst und getestet werden. Es werden keine Zugangsdaten in Projektdateien abgelegt.
