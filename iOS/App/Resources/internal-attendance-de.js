...
(function(){
  ...
  var I18N={
    withFood:'Mit Essen',
    withoutFood:'Ohne Essen',
    notSelected:'Nicht gewählt',
    notComing:'Komme nicht',
    standard:'Standard',
    remove:'Entfernen',
    noSelection:'Keine Auswahl für diesen Termin',
    rebuild:'Aus Initiallink neu aufbauen',
    cleanupTitle:'Ansicht bereinigen',
    cleanupNote:'Falls die Personenansicht festhängt oder zu viele Personen geladen wurden, kann sie aus dem gespeicherten persönlichen Initiallink vollständig neu aufgebaut werden.',
    rebuildConfirm:'Nochmal tippen: wirklich neu aufbauen',
    initialUnavailable:'Initiallink nicht verfügbar',
    managePeople:'Personen verwalten',
    close:'Schliessen',
    addPerson:'Person hinzufügen:',
    addUnavailable:'Hinzufügen ist auf diesem Seitenstand nicht verfügbar. Vorhandene Zusatzpersonen können weiterhin entfernt werden oder die Ansicht kann unten aus dem Initiallink neu aufgebaut werden.',
    removeNote:'Entfernen aktualisiert die Personenliste automatisch.',
    currentPeople:'Aktuelle Personen',
    appointment:'Termin',
    removeFromView:'Person aus Ansicht entfernen: ',
    addPersonAria:'Person hinzufügen',
    participant:'Teilnehmer',
    restoreSaved:'Gespeicherte Personen wiederherstellen'
  };
