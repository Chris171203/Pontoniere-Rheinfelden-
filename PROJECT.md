...
- Home mit allen laufenden oder kommenden Anlässen am nächsten relevanten Vereinstag und Wetter je Terminzeitraum. Ein dezenter Refresh-Tap direkt beim ersten sichtbaren Live-Block (standardmässig `Wetter zum nächsten Termin`) erzwingt bei Bedarf einen neuen Abruf der Live-Wetter- und Rheindaten, ohne den Umweg über Einstellungen.
  ...
  - Mittag und Abend werden bei zwei Terminen getrennt angezeigt; bei nur einem Abendtermin erscheinen keine Mittagswerte. Ein ausdrücklich eingetragenes Training wird nicht als Regeltraining dupliziert. Laufende mehrtägige Anlässe verwenden den ausgewählten Tag in Europe/Zurich.
