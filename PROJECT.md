...
- Home mit Wetter zum nächsten relevanten Vereinsanlass. Ein dezenter Refresh-Tap direkt beim ersten sichtbaren Live-Block (standardmässig `Wetter zum nächsten Termin`) erzwingt bei Bedarf einen neuen Abruf der Live-Wetter- und Rheindaten, ohne den Umweg über Einstellungen.
...
- Verein und Kontakt mit nativen News, App-Jahresprogramm sowie aus der öffentlichen WordPress-API geladenen Textansichten für Verein/Sport, Vorstand, Geschichte und Kontakt. Öffentliche Seiten werden einzeln für 24 Stunden lokal gecacht; Fehler überschreiben keinen erfolgreichen Stand. Kontaktformulare, PDFs und Bildgalerien werden bei Bedarf extern geöffnet. Instagram/Facebook stehen als offizielle Logos zentriert unter den Vereins-Kacheln; direkte Telefon-/E-Mail-Aktionen bleiben erhalten. Der eigene Schnuppertraining-/Mitgliedschaftseinstieg bleibt auf der öffentlichen Landingpage vor der Erstfreigabe; aus der Website übernommene Texte und Links bleiben als Quellinhalt erhalten.
