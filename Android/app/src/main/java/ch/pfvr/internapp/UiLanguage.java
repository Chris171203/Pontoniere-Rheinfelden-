...
final class UiLanguage {
    ...
    static {
        ...
        put("Schnuppertraining, Mitgliedschaft und Formulare findest du auf pfvr.ch.", "Schnuppertraining, Mitgliedschaft und Formular findsch uf pfvr.ch.");
        ...
        put("Infos, Einstieg und Formulare", "Infos, Iistig und Formular");
        ...
        put("Noch keine Banking-App festgelegt", "No kei Banking-App festgleit");
